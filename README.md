...
df_new['Survived'] = y.values df_new.to_csv('titanic_transformed.csv', index=False)
print(df_new)
...
X = df.iloc[:, :-1]
y = df.iloc[:, -1] X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2, random_state=1)
...
# OUPUT
![EX-07-FEATURE-TRANSFORMATION](ex7(1).png)
![EX-07-FEATURE-TRANSFORMATION](ex7(2).png)
![EX-07-FEATURE-TRANSFORMATION](ex7(3).png)
![EX-07-FEATURE-TRANSFORMATION](ex7(4).png)
![EX-07-FEATURE-TRANSFORMATION](ex7(5).png)
